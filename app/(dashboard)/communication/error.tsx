...
export default function CommunicationError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error('[Communication] Unhandled error:', error)
  }, [error])
      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-[--color-foreground-muted]">
            An error occurred while loading the Communication Center. Please try again.
          </p>
          {error.digest && (
